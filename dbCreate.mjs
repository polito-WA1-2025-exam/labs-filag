...
const queries = [
    ...
    "CREATE TABLE IF NOT EXISTS BOWL_COMPOSITION (BowlId INTEGER, IngredientId INTEGER, FOREIGN KEY (BowlId) REFERENCES BOWL(BowlId), FOREIGN KEY (IngredientId) REFERENCES INGREDIENTS(IngredientId), PRIMARY KEY (BowlId, IngredientId))",
