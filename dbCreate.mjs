...
const queries = [
    ...
    "CREATE TABLE IF NOT EXISTS BOWL_COMPOSITION (BowlId INTEGER, IngredientsId INTEGER, FOREIGN KEY (BowlId) REFERENCES BOWL(BowlId), FOREIGN KEY (IngredientId) REFERENCES INGREDIENTS(IngredientsId), PRIMARY KEY (BowlId, IngredientsId))",
